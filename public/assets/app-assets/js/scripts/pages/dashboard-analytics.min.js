$(window).on("load", (function() {
    ...
    setTimeout((function() {
        toastr.success("You have successfully logged in to IPPIS Harmonized Database. Now you can start to upload project changes ", "👋 Welcome!", { closeButton: !0, tapToDismiss: !1, rtl: w })
